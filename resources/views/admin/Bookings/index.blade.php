...
@section("content")
    ...
    </div><div class="modal fade" id="edit_boking">
        <div class="modal-dialog">
            <form method="post" action="{{ url("#") }}">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="control">
                                <input class="form-control required" name="first_name" id="edit_booking_name" required>
                            </div>
                        </div>
                    </div>
                    <div class="modal-body">
    ...
    @section('script')
        ...
        <script>
            ...
            function format ( d) {
                ...
                html += '<label>Booking Date : </label>' + d.booking_date+ '<br>';
                html += '<label>Event : </label>' + d.event.event_type+ '<br>';
                html += '<label>Transaction ID : </label>' + d.transaction_id+ '<br>';
                html += '<label>Tables : </label>' + d.select_tables + '<br>';
                html += '<label>Seats : </label>' + d.select_tickets + '<br>';
                html += '<label>amount : </label>' + d.amount + '<br>';
                html += '</div>';
                return html;
            }
